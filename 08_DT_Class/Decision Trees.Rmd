...
winequality <- read.csv("~/DS-3001/data/winequality-red-ddl.csv")
# View(winequality)
str(winequality)
...
# winequality1 = winequality 
# winequality1$text_rank = as.factor(winequality$text_rank)

# histogram(winequality1$text_rank)
...
adjust_thres(wine_pred_tune$excellent,y=.1,tune$text_rank)
...
```{r}
tree_example <- tibble(import("~/DS-3001/data/pregnancy.csv", check.names= TRUE))
